    ...
    <div className="portfolio-chart" role="img" aria-label="Portfolio value history chart">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 12, right: 12, left: 0, bottom: 4 }}>
          ...
          <XAxis dataKey="time" type="number" domain={['dataMin', 'dataMax']} tickFormatter={formatDate} stroke="#777183" tickLine={false} axisLine={false} minTickGap={28} />
          <YAxis tickFormatter={formatGBP} stroke="#777183" tickLine={false} axisLine={false} width={76} />
          <Tooltip
